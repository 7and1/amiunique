    ...
    <div className="flex flex-col">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
                AmiUnique.io quantifies how identifiable your browser is in a database of 2M+
                fingerprints. The Neo-SaaS interface blends transparency, statistical storytelling,
                and privacy-first messaging so users understand every signal being collected.
              </p>
            </div>
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-muted-foreground">
              Each card surfaces a high-value dimension with its rarity badge so security teams see
              where to focus mitigation (e.g., reduce installed fonts, normalize screen settings, or
              rotate network egress).
            </p>
          </div>
          <Link
            href="/scan/result"
      ...
      <section className="container mx-auto space-y-10 px-4 py-16">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-muted-foreground">
            Every fingerprint dimension is documented, auditable, and designed to help you
        ...
        <div className="container mx-auto max-w-4xl px-4">
          <article className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <div className="rounded-3xl border border-white/30 bg-white/80 p-8 shadow-lg dark:border-white/5 dark:bg-slate-800/50 mb-8">
              ...
              <p className="text-slate-600 dark:text-slate-300 mb-4">
                Think of it like this: Imagine walking into a room and someone could identify you
                just by the way you walk, the shoes you wear, the watch on your wrist, and the phone
                in your pocket. They don&apos;t need your name. They don&apos;t need your ID. They
                just...{' '}
              ...
              <p className="text-slate-600 dark:text-slate-300">
                ...
                visit a site. And it works even in &quot;private&quot; or &quot;incognito&quot;
                mode.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-white/30 bg-white/80 p-8 shadow-lg dark:border-white/5 dark:bg-slate-800/50 mb-8">
              ...
              <p className="text-slate-600 dark:text-slate-300 mb-6">
                We&apos;ve analyzed millions of browser fingerprints. The research is clear - and
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-slate-700">
                      <th className="py-3 px-4 text-left font-semibold text-slate-900 dark:text-white">
                        Device Type
                      </th>
                      <th className="py-3 px-4 text-left font-semibold text-slate-900 dark:text-white">
                        Uniqueness Rate
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl bg-rose-50 dark:bg-rose-500/10 p-4 border border-rose-200 dark:border-rose-500/20">
                  ...
                  <p className="text-sm text-rose-600 dark:text-rose-300">
                    Within just 24 hours, nearly <span className="font-bold">10% of devices</span>{' '}
                    change their fingerprint. But the remaining 90%? They&apos;re trackable for
                    weeks or months.
                  </p>
                </div>
            ...
            <div className="rounded-3xl border border-white/30 bg-white/80 p-8 shadow-lg dark:border-white/5 dark:bg-slate-800/50 mb-8">
              ...
              <p className="text-slate-600 dark:text-slate-300 mb-4">
                Here&apos;s the thing -{' '}
                <span className="font-semibold">over 70% of internet users</span> say they&apos;re
                concerned about online tracking. But only{' '}
                <span className="font-semibold">43% actually understand</span> how it works. That
                gap is a problem.
              </p>
              <p className="text-slate-600 dark:text-slate-300 mb-4">
              ...
              <ul className="space-y-3 mb-4">
                <li className="flex items-start gap-3 text-slate-600 dark:text-slate-300">
                  ...
                  <span>
                    <span className="font-semibold">Cross-site tracking</span> - Advertisers can
                    follow you across the entire internet, even without cookies
                  </span>
                </li>
                <li className="flex items-start gap-3 text-slate-600 dark:text-slate-300">
                  <span className="mt-1 h-2 w-2 rounded-full bg-amber-500 flex-shrink-0" />
                  <span>
                    <span className="font-semibold">Price discrimination</span> - Some sites show
                    different prices based on your device and location profile
                  </span>
                </li>
                <li className="flex items-start gap-3 text-slate-600 dark:text-slate-300">
                  <span className="mt-1 h-2 w-2 rounded-full bg-purple-500 flex-shrink-0" />
                  <span>
                    <span className="font-semibold">Account linking</span> - Your
                    &quot;anonymous&quot; browsing can be connected to your real identity
                  </span>
                </li>
                <li className="flex items-start gap-3 text-slate-600 dark:text-slate-300">
                  <span className="mt-1 h-2 w-2 rounded-full bg-indigo-500 flex-shrink-0" />
                  <span>
                    <span className="font-semibold">Bypassing consent</span> - Unlike cookies,
                    fingerprinting doesn&apos;t require your permission under most regulations
                  </span>
                </li>
              </ul>
              <p className="text-slate-600 dark:text-slate-300">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl bg-amber-50 dark:bg-amber-500/10 p-5 border border-amber-200 dark:border-amber-500/20">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs bg-amber-200 dark:bg-amber-500/30 text-amber-800 dark:text-amber-300 px-2 py-0.5 rounded-full">
                      Most Stable
                    </span>
                  </div>
                  <p className="text-sm text-amber-700 dark:text-amber-300">
                    Canvas rendering, WebGL signatures, audio processing patterns, GPU
                    characteristics. These survive browser reinstalls and even persist across
                ...
                <div className="rounded-2xl bg-slate-100 dark:bg-slate-700/50 p-5 border border-slate-200 dark:border-slate-600">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Installed fonts, browser plugins, language settings, timezone, screen
                    resolution. These change when you update your browser or OS.
                  </p>
                </div>
                ...
                <div className="rounded-2xl bg-orange-50 dark:bg-orange-500/10 p-5 border border-orange-200 dark:border-orange-500/20">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs bg-orange-200 dark:bg-orange-500/30 text-orange-800 dark:text-orange-300 px-2 py-0.5 rounded-full">
                      Session-Specific
                    </span>
                  </div>
                  <p className="text-sm text-orange-700 dark:text-orange-300">
                    IP address, ASN (your internet provider), TLS cipher suites, connection timing.
                    These change when you switch networks or use a VPN.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-white/30 bg-white/80 p-8 shadow-lg dark:border-white/5 dark:bg-slate-800/50 mb-8">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-start gap-3 rounded-xl bg-slate-50 dark:bg-slate-700/30 p-4"
                  >
            ...
            <div className="rounded-3xl bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700 p-8 text-white shadow-2xl">
              ...
              <p className="text-white/90 mb-4">
                Browser fingerprinting isn&apos;t going away. In fact, as cookies become less
                reliable for tracking, fingerprinting is becoming{' '}
              ...
              <p className="text-white/90 mb-6">
                We built AmiUnique.io to give you that visibility. No tracking, no data selling -
                just honest, transparent information about your digital identity. Because you
                deserve to know.
              </p>
            ...
            <div className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-700">
              <p className="text-xs text-slate-500 dark:text-slate-500 mb-2 font-semibold uppercase tracking-wider">
              ...
              <ul className="text-xs text-slate-400 dark:text-slate-500 space-y-1">
                <li>
                  ...
                  >
                    INRIA/Inria: &quot;Hiding in the Crowd: An Analysis of the Effectiveness of
