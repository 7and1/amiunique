      ...
      <div className="container mx-auto max-w-3xl px-4 space-y-12">
        ...
        <header className="text-center space-y-4">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-xl mx-auto">
            Exercise your privacy rights under GDPR and CCPA. Queued requests are normally processed
            within 24 hours.
          </p>
        </header>
        ...
        <section className="rounded-3xl border border-white/30 bg-white/80 p-6 shadow-card dark:border-white/5 dark:bg-white/5">
          ...
          <p className="text-sm text-muted-foreground">
            Prefer to write your own note? Email{' '}
            <a className="font-medium text-indigo-500" href="mailto:privacy@amiunique.io">
              privacy@amiunique.io
            </a>{' '}
            with the subject “Delete my AmiUnique fingerprint” and include the bronze hash plus any
            gold/silver hashes you have.
          </p>
