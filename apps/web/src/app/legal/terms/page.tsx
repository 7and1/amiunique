    ...
    <div className="py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <section className="mb-12">
            ...
            <p className="text-muted-foreground">
              By accessing and using AmiUnique.io (&quot;the Service&quot;), you accept and agree to
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground">
              ...
              AmiUnique.io and is protected by international copyright, trademark, and other
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground">
              ...
              WILL BE UNINTERRUPTED, SECURE, OR ERROR-FREE. FINGERPRINT ANALYSIS RESULTS ARE FOR
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground mb-4">If you access the Service through our API:</p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground">
              ...
              the Service after such modifications constitutes acceptance of the new Terms.
            </p>
          </section>
        ...
        <div className="mt-12 text-center text-sm text-muted-foreground">
          <p>
            By using AmiUnique.io, you acknowledge that you have read, understood, and agree to be
