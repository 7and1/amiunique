...
1. **CLOUDFLARE_API_TOKEN**
   ...
   - **Required permissions**:
     ...
     - Account.D1: Edit
   - **Value format**: `zXwKNqnaEQruZ_1qYRDFltQYiDDZipNiTaDm7ttD`
   - **Current account**: info@opportunitygreen.com

2. **CLOUDFLARE_ACCOUNT_ID**
   - **Description**: Your Cloudflare account ID
   - **How to get**: Cloudflare Dashboard → Workers & Pages → Overview (right sidebar)
   - **Value**: `873cd683fb162639ab3732a3a995b64b`
   - **Note**: This is NOT sensitive and can be committed, but we use secrets for consistency
